...
class CustomerException extends HttpException
{
    ...
    public static function downloadFileNotFound(string $downloadId): CicadaHttpException
    {
        return new self(
            Response::HTTP_NOT_FOUND,
    ...
    public static function customerIdsParameterIsMissing(): CicadaHttpException
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
    ...
    public static function productIdsParameterIsMissing(): CicadaHttpException
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
    ...
    public static function cannotDeleteActiveAddress(string $id): CicadaHttpException
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
    ...
    public static function customerGroupRegistrationConfigurationNotFound(string $customerGroupId): CicadaHttpException
    {
        return new self(
            Response::HTTP_NOT_FOUND,
    ...
    public static function customerWishlistNotActivated(): CicadaHttpException
    {
        return new self(
            Response::HTTP_FORBIDDEN,
    ...
    public static function legacyPasswordEncoderNotFound(string $encoder): CicadaHttpException
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
    ...
    public static function noHashProvided(): CicadaHttpException
    {
        return new self(
            Response::HTTP_NOT_FOUND,
    ...
    public static function wishlistProductNotFound(string $productId): CicadaHttpException
    {
        return new self(
            Response::HTTP_NOT_FOUND,
     ...
     */
    public static function inactiveCustomer(string $id): CicadaHttpException
    {
    ...
    public static function guestAccountInvalidAuth(): CicadaHttpException
    {
        return new self(
            Response::HTTP_FORBIDDEN,
