...
class SystemSetupCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('es-enabled', null, InputOption::VALUE_OPTIONAL, 'Elasticsearch enabled', $this->getDefault('CICADA_ES_ENABLED', '0'))
            ->addOption('es-hosts', null, InputOption::VALUE_OPTIONAL, 'Elasticsearch Hosts', $this->getDefault('OPENSEARCH_URL', 'elasticsearch:9200'))
            ->addOption('es-indexing-enabled', null, InputOption::VALUE_OPTIONAL, 'Elasticsearch Indexing enabled', $this->getDefault('CICADA_ES_INDEXING_ENABLED', '0'))
            ->addOption('es-index-prefix', null, InputOption::VALUE_OPTIONAL, 'Elasticsearch Index prefix', $this->getDefault('CICADA_ES_INDEX_PREFIX', 'sw'))
            ...
            ->addOption('admin-es-index-prefix', null, InputOption::VALUE_OPTIONAL, 'Admin Elasticsearch Index prefix', $this->getDefault('CICADA_ADMIN_ES_INDEX_PREFIX', 'sw-admin'))
            ->addOption('admin-es-enabled', null, InputOption::VALUE_OPTIONAL, 'Admin Elasticsearch Enabled', $this->getDefault('CICADA_ADMIN_ES_ENABLED', '0'))
            ->addOption('admin-es-refresh-indices', null, InputOption::VALUE_OPTIONAL, 'Admin Elasticsearch Refresh Indices', $this->getDefault('CICADA_ADMIN_ES_REFRESH_INDICES', '0'))
            ...
            ->addOption('cdn-strategy', null, InputOption::VALUE_OPTIONAL, 'CDN Strategy', $this->getDefault('CICADA_CDN_STRATEGY_DEFAULT', 'id'))
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        $env = [
            ...
            'CICADA_ES_ENABLED' => $input->getOption('es-enabled'),
            'CICADA_ES_INDEXING_ENABLED' => $input->getOption('es-indexing-enabled'),
            'CICADA_ES_INDEX_PREFIX' => $input->getOption('es-index-prefix'),
            'ADMIN_OPENSEARCH_URL' => $input->getOption('admin-es-hosts'),
            'CICADA_ADMIN_ES_INDEX_PREFIX' => $input->getOption('admin-es-index-prefix'),
            'CICADA_ADMIN_ES_ENABLED' => $input->getOption('admin-es-enabled'),
            'CICADA_ADMIN_ES_REFRESH_INDICES' => $input->getOption('admin-es-refresh-indices'),
