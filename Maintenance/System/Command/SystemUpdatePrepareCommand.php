...
{
    public function __construct(private readonly ContainerInterface $container, private readonly string $cicadaVersion)
    {
        parent::__construct();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $eventDispatcher->dispatch(new UpdatePrePrepareEvent($context, $this->cicadaVersion, $newVersion));

        $eventDispatcher->dispatch(new UpdatePostPrepareEvent($context, $this->cicadaVersion, $newVersion));
