...
class MailService extends AbstractMailService
{
    ...
    public function send(array $data, Context $context, array $templateData = []): ?Email
    {
        ...
        if ($this->isTestMode($data)) {
            ...
            $headers->addTextHeader('X-Cicada-Event-Name', $templateData['eventName'] ?? '');
            $headers->addTextHeader('X-Cicada-Sales-Channel-Id', $salesChannelId);
            $headers->addTextHeader('X-Cicada-Language-Id', $context->getLanguageId());
