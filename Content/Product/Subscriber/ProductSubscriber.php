...
namespace Cicada\Core\Content\Product\Subscriber;

use Cicada\Core\Content\Product\AbstractIsNewDetector;
use Cicada\Core\Content\Product\AbstractProductMaxPurchaseCalculator;
use Cicada\Core\Content\Product\AbstractProductVariationBuilder;
