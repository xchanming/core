...
use Cicada\Core\Content\ImportExport\Exception\FileEmptyException;
use Cicada\Core\Content\ImportExport\Exception\FileNotFoundException;
use Cicada\Core\Content\ImportExport\Exception\FileNotReadableException;
use Cicada\Core\Content\ImportExport\Exception\InvalidFileAccessTokenException;
use Cicada\Core\Content\ImportExport\Exception\InvalidFileContentException;
use Cicada\Core\Content\ImportExport\Exception\InvalidIdentifierException;
use Cicada\Core\Content\ImportExport\Exception\ProcessingException;
use Cicada\Core\Content\ImportExport\Exception\ProfileNotFoundException;
...
class ImportExportException extends HttpException
{
    ...
    public static function invalidFileAccessToken(): CicadaHttpException
    {
        return new InvalidFileAccessTokenException();
    }

    public static function fileNotFound(string $fileId): CicadaHttpException
    {
        return new FileNotFoundException($fileId);
    }

    public static function processingError(string $message): CicadaHttpException
    {
        return new ProcessingException($message);
    }

    public static function requiredByUser(string $column): CicadaHttpException
    {
        return new RequiredByUserException($column);
    }

    public static function invalidIdentifier(string $id): CicadaHttpException
    {
        return new InvalidIdentifierException($id);
    }

    public static function decorationPattern(string $class): CicadaHttpException
    {
        return new DecorationPatternException($class);
    }

    public static function profileNotFound(string $profileId): CicadaHttpException
    {
     ...
     */
    public static function fileEmpty(string $filename): self|CicadaHttpException
    {
     ...
     * @deprecated tag:v6.7.0 - reason:return-type-change - Will only return 'self' in the future
     */
    public static function fileNotReadable(string $path): self|CicadaHttpException
    {
        if (!Feature::isActive('v6.7.0.0')) {
     ...
     * @deprecated tag:v6.7.0 - reason:return-type-change - Will only return 'self' in the future
     */
    public static function invalidFileContent(string $filename): CicadaHttpException
    {
        if (!Feature::isActive('v6.7.0.0')) {
     ...
     * @deprecated tag:v6.7.0 - reason:return-type-change - Will only return 'self' in the future
     */
    public static function profileWrongType(string $profileId, string $profileType): self|CicadaHttpException
    {
        if (!Feature::isActive('v6.7.0.0')) {
     ...
     * @deprecated tag:v6.7.0 - reason:return-type-change - Will only return 'self' in the future
     */
    public static function unexpectedFileType(string $givenType, string $expectedType): self|CicadaHttpException
    {
        if (!Feature::isActive('v6.7.0.0')) {
