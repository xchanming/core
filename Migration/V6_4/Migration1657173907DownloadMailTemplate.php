...
class Migration1657173907DownloadMailTemplate extends MigrationStep
{
    ...
    private const CHINESE_LANGUAGE_NAME = 'Chinese';
    ...
    private function updateMailTemplateContent(Connection $connection): void
    {
        $update = new MailUpdate(
            ...
            (string) file_get_contents(__DIR__ . '/../Fixtures/mails/downloads_delivery/zh-plain.html.twig'),
            (string) file_get_contents(__DIR__ . '/../Fixtures/mails/downloads_delivery/zh-html.html.twig')
        );
    ...
    private function insertMailTemplateTypeData(Connection $connection): string
    {
        ...
        $germanLanguageId = $this->fetchLanguageIdByName(self::CHINESE_LANGUAGE_NAME, $connection);
