...
## [`Cicada\Core\Content\Product\Hook\Pricing\CheapestPriceFacade`](https://github.com/cicada-ag/platform/blob/trunk/src/Core/Content/Product/Hook/Pricing/CheapestPriceFacade.php) {#cheapestpricefacade}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        {% endraw %}
_________
## [`Cicada\Core\Content\Product\Hook\Pricing\PriceCollectionFacade`](https://github.com/cicada-ag/platform/blob/trunk/src/Core/Content/Product/Hook/Pricing/PriceCollectionFacade.php) {#pricecollectionfacade}
...
_________
## [`Cicada\Core\Content\Product\Hook\Pricing\ProductProxy`](https://github.com/cicada-ag/platform/blob/trunk/src/Core/Content/Product/Hook/Pricing/ProductProxy.php) {#productproxy}
