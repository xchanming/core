...
## [services.request (`Cicada\Core\Framework\Routing\Facade\RequestFacade`)](https://github.com/cicada-ag/platform/blob/trunk/src/Core/Framework/Routing/Facade/RequestFacade.php) {#requestfacade}
...
* **Returns** `array`
    ...
    request cookies
_________
## [`Cicada\Core\Framework\Script\Facade\ArrayFacade`](https://github.com/cicada-ag/platform/blob/trunk/src/Core/Framework/Script/Facade/ArrayFacade.php) {#arrayfacade}
...
_________
## [services.config (`Cicada\Core\System\SystemConfig\Facade\SystemConfigFacade`)](https://github.com/cicada-ag/platform/blob/trunk/src/Core/System/SystemConfig/Facade/SystemConfigFacade.php) {#systemconfigfacade}
