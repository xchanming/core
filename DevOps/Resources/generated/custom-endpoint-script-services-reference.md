...
## [services.cache (`Cicada\Core\Framework\Adapter\Cache\Script\Facade\CacheInvalidatorFacade`)](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/Adapter/Cache/Script/Facade/CacheInvalidatorFacade.php) {#cacheinvalidatorfacade}
...
* **Examples:**
    ...
    * Build tags if products with a specific property is created and invalidate those tags.
        ...
        {% endraw %}
_________
## [services.writer (`Cicada\Core\Framework\DataAbstractionLayer\Facade\RepositoryWriterFacade`)](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryWriterFacade.php) {#repositorywriterfacade}
...
* **Returns** [`Cicada\Core\Framework\DataAbstractionLayer\Event\EntityWrittenContainerEvent`](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/DataAbstractionLayer/Event/EntityWrittenContainerEvent.php)
...
* **Returns** [`Cicada\Core\Framework\Api\Sync\SyncResult`](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/Api/Sync/SyncResult.php)
...
* **Examples:**
    * Update an entity and delete another one with one `sync()` call.
        ...
        {% endraw %}
_________
## [services.response (`Cicada\Core\Framework\Script\Api\ScriptResponseFactoryFacade`)](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/Script/Api/ScriptResponseFactoryFacade.php) {#scriptresponsefactoryfacade}
...
* **Returns** [`Cicada\Core\Framework\Script\Api\ScriptResponse`](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/Script/Api/ScriptResponse.php)
