...
## [services.repository (`Cicada\Core\Framework\DataAbstractionLayer\Facade\RepositoryFacade`)](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryFacade.php) {#repositoryfacade}
...
* **Returns** [`Cicada\Core\Framework\DataAbstractionLayer\Search\EntitySearchResult`](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/EntitySearchResult.php)
...
* **Returns** [`Cicada\Core\Framework\DataAbstractionLayer\Search\IdSearchResult`](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/IdSearchResult.php)
...
* **Returns** [`Cicada\Core\Framework\DataAbstractionLayer\Search\AggregationResult\AggregationResultCollection`](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/AggregationResult/AggregationResultCollection.php)
...
* **Examples:**
    * Aggregate data for multiple entities, e.g. the sum of the gross price of all products.
        ...
        {% endraw %}
_________
## [services.store (`Cicada\Core\Framework\DataAbstractionLayer\Facade\SalesChannelRepositoryFacade`)](https://github.com/cicada-ag/cicada/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/SalesChannelRepositoryFacade.php) {#saleschannelrepositoryfacade}
