...
class ServiceReferenceGenerator implements ScriptReferenceGenerator
{
    ...
    final public const GITHUB_BASE_LINK = 'https://github.com/cicada-ag/platform/blob/trunk';
    ...
    {
        if (!str_starts_with($className, 'Cicada\\') || !\class_exists($className)) {
            return null;
        }
    ...
    private function findScriptServices(): array
    {
        ...
        foreach (ScriptReferenceDataCollector::getCicadaClasses() as $class) {
