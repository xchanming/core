...
class AddColumnRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        if (str_contains($fullyQualifiedClassName, 'Cicada\\Core\\Migration\\V6_4')
            || str_contains($fullyQualifiedClassName, 'Cicada\\Core\\Migration\\V6_3')
        ) {
            return [];
        }
