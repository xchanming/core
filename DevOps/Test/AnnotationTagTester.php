...
namespace Cicada\Core\DevOps\Test;
...
{
    /**
     * captures any cicada version like 6.4.0.0 but also old version with 3 digits like 6.2.0
     */
    ...
    private function validateAgainstPlatformVersion(string $version): void
    {
        ...
        $this->compareVersion($this->cicadaVersion, $matches[1]);
    }
