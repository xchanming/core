...
class CreateGeneratorScaffoldingCommandPass implements CompilerPassInterface
{
    ...
    {
        $generators = $container->findTaggedServiceIds('cicada.scaffold.generator');
        ...
        foreach ($generators as $id => $tags) {
            ...
            if (!is_subclass_of($class, ScaffoldingGenerator::class)) {
                throw DependencyInjectionException::taggedServiceHasWrongType($id, 'cicada.scaffold.generator', ScaffoldingGenerator::class);
            }
