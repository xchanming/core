...
class AppPrinter
{
    ...
    public function printInstalledApps(CicadaStyle $io, Context $context): void
    {
     ...
     */
    public function printIncompleteInstallations(CicadaStyle $io, array $fails): void
    {
        if (empty($fails)) {
            return;
        }
    ...
    public function printPermissions(Manifest $manifest, CicadaStyle $io, bool $install): void
    {
     ...
     */
    public function checkHosts(Manifest $manifest, CicadaStyle $io): void
    {
     ...
     */
    private function printHosts(Manifest $app, array $hosts, CicadaStyle $io, bool $install): void
    {
        $io->caution(
            \sprintf(
    ...
    private function printPermissionTable(CicadaStyle $io, Permissions $permissions): void
    {
        $permissionTable = [];
