...
class RefreshAppCommand extends Command
{
    ...
    private function validateRefreshableApps(RefreshableAppDryRun $refreshableApps, CicadaStyle $io, Context $context): int
    {
    ...
    private function grantPermissions(RefreshableAppDryRun $refreshableApps, CicadaStyle $io): void
    {
        $default = true;
    ...
    private function grantPermissionsForApp(Manifest $app, CicadaStyle $io, bool $install = true): void
    {
