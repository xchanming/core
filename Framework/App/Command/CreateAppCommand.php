...
class CreateAppCommand extends Command
{
     ...
     */
    private function gatherDetails(array $propertyDefinitions, CicadaStyle $io, InputInterface $input): array
    {
        return array_map(
    ...
    private function getManifestTemplate(): string
    {
        ...
        <manifest xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/xchanming/cicada/trunk/src/Core/Framework/App/Manifest/Schema/manifest-2.0.xsd">
            <meta>
                <name>{{name}}</name>
                <label>{{label}}</label>
