...
use Cicada\Core\Framework\App\Exception\AppFlowException;
...
use Cicada\Core\Framework\App\Exception\InvalidAppFlowActionVariableException;
...
use Cicada\Core\Framework\App\Validation\Error\Error;
...
class AppException extends HttpException
{
    ...
    public static function notCompatible(string $pluginName): self
    {
        return new self(
            Response::HTTP_BAD_REQUEST,
            self::NOT_COMPATIBLE,
            'App {{ name }} is not compatible with this Cicada version',
            ['name' => $pluginName]
        );
    }
