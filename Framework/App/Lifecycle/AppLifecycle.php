...
use Cicada\Core\Framework\App\Event\Hooks\AppDeletedHook;
use Cicada\Core\Framework\App\Event\Hooks\AppInstalledHook;
use Cicada\Core\Framework\App\Event\Hooks\AppUpdatedHook;
...
use Cicada\Core\Framework\App\Manifest\Xml\Administration\Module;
use Cicada\Core\Framework\App\Manifest\Xml\Webhook\Webhook;
...
use Cicada\Core\System\CustomEntity\CustomEntityCollection;
...
use Cicada\Core\System\CustomEntity\Xml\Field\AssociationField;
...
class AppLifecycle extends AbstractAppLifecycle
{
    ...
    public function ensureIsCompatible(Manifest $manifest): void
    {
        ...
        if (!$manifest->getMetadata()->getCompatibility()->matches($versionParser->parseConstraints($this->cicadaVersion))) {
