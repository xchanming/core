...
{
    private const MARKER_START = '# BEGIN Cicada';
    private const MARKER_STOP = '# END Cicada';
    private const INSTRUCTIONS = '# The directives (lines) between "# BEGIN Cicada" and "# END Cicada" are dynamically generated. Any changes to the directives between these markers will be overwritten.';

    private const OLD_FILES = [
        '9ab5be8c4bbff3490f3ae367af8a30d7', // https://github.com/cicada/production/commit/bebf9adc90bf5d7b0d53a149cc5bdba328696086
        'ba812f2a64b337b032b10685ca6e2308', // https://github.com/cicada/production/commit/18ce6ffc904b8d2d237dc4ee6654c1fa9a6df719
    ];
