...
/**
 * @deprecated tag:v6.7.0 - Will be replaced by public Cicada\Core\Test\Stub\Framework\IdsCollection in v6.7.0
 *
 * @internal
 */
#[Package('core')]
class IdsCollection
{
    ...
    {
        Feature::triggerDeprecationOrThrow('v6.7.0.0', 'Will be replaced by public Cicada\Core\Test\Stub\Framework\IdsCollection.');
        $this->ids = $ids;
    }
